...
from core.exceptions import UsuarioNaoEncontrado
from core.exceptions import CredenciaisInvalidas
from core.exceptions import UsuarioJaExiste
...
async def empresa_nao_encontrada_handler(
    request: Request,
    exc: EmpresaNaoEncontrada
):
...
async def credenciais_handler(
    request: Request,
    exc: CredenciaisInvalidas
):
